    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="fixed inset-y-0 left-0 w-[260px] bg-white shadow-xl z-50">
            {sidebarContent}
          </div>
        </div>
      )}
      ...
      {/* Desktop sidebar */}
      <div className="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex lg:w-[260px] lg:flex-col bg-white border-r border-gray-200">
        {sidebarContent}
      </div>
    </>
  );
